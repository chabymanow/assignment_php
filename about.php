    ...
    lg:flex-row lg:v-[70%] lg:max-w-[1536px] lg:justify-between">
        ...
        lg:w-[45%]">
            <?php
                ...
                <span class="text-4xl text-center w-screen font-bolder mb-10
                lg:w-[90%]"><?php echo $row["collegeName"]; ?></span>
        ...
        <div class="w-[90%] my-10 justify-center
        lg:w-[45%] lg:max-w-[600px]">
